...
function load() {
 if (GBrowserIsCompatible()) {
		...
		map.setCenter(new GLatLng(151.207114, -33.867139), 12); //set center to sydney
                map.setUIToDefault();
                showStartingMarker();
      	}
}
			...
			function(point) {
				if (!point) {
					// do something
                                	...
                                	var centerLat = -33.867139;
                                        var centerLng = 151.207114;
					...
					var centerLat = -33.867139;
    					...
    					marker.title = "Sydney Airport";
    				        ...
    				        GEvent.addListener(marker, "mouseover", function() {
                                              ...
                                              html = '<div style="font-family:arial;font-size:28px;text-align:left;color:green;">' + "You Are Here " + '</div>' + '<div style="font-family:arial;font-size:17px;text-align:right;color:green;">' + "SYDNEY AIRPORT" + '</div>';
