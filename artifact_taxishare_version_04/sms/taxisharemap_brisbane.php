...
<script type="text/javascript">
	...
	var map;
	var address = "Brisbane Australia";
	var centerLat;
	var centerLng;
	var airportname ="Brisbane Airport";
	var cur_sms_format;
...
function load() {
 if (GBrowserIsCompatible()) {
		...
		map.setCenter(new GLatLng(153.0278778076172, -27.46563202185068), 12);   
                map.setUIToDefault();
                showStartingMarker();
      	}
}
			...
			function(point) {
				if (!point) {
					// do something
                                	...
                                	var centerLat = -27.46563202185068;
                                        var centerLng = 153.0278778076172;
