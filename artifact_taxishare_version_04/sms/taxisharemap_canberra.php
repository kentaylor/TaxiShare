...
<script type="text/javascript">
	...
	var map;
	var address = "Canberra Australia";
	var centerLat;
	var centerLng;
	var airportname ="Canberra Airport";
	var cur_sms_format;
...
function load() {
 if (GBrowserIsCompatible()) {
		...
		map.setCenter(new GLatLng(149.13253784179687, -35.25963722105543), 12); 
                map.setUIToDefault();
                showStartingMarker();
      	}
}
			...
			function(point) {
				if (!point) {
					// do something
                                	...
                                	var centerLat = -35.25963722105543;
                                        var centerLng = 149.13253784179687;
