...
<script type="text/javascript">
	...
	var map;
	var address = "Newcastle Australia";
	var centerLat;
	var centerLng;
	var airportname ="Newcastle Airport";
	var cur_sms_format;
...
function load() {
 if (GBrowserIsCompatible()) {
		...
		map.setCenter(new GLatLng(-32.79637, 151.83466), 12); 
                map.setUIToDefault();
                showStartingMarker();
      	}
}
			...
			function(point) {
				if (!point) {
					// do something
                                	...
                                	var centerLat = -32.79637;
                                        var centerLng = 151.83466;
