...
<script type="text/javascript">
	...
	var map;
	var address = "Perth Australia";
	var centerLat;
	var centerLng;
	var airportname ="Perth Airport";
	var cur_sms_format;
...
function load() {
 if (GBrowserIsCompatible()) {
		...
		map.setCenter(new GLatLng(115.84945678710937, -31.953910057440804), 12);
                map.setUIToDefault();
                showStartingMarker();
      	}
}
			...
			function(point) {
				if (!point) {
					// do something
                                	...
                                	var centerLat = -31.953910057440804;
                                        var centerLng = 115.84945678710937;
