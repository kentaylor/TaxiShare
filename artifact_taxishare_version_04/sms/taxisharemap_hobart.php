...
<script type="text/javascript">
	...
	var map;
	var address = "Hobart Australia";
	var centerLat;
	var centerLng;
	var airportname ="Hobart Airport";
	var cur_sms_format;
...
function load() {
 if (GBrowserIsCompatible()) {
		...
		map.setCenter(new GLatLng(147.34451293945312, -42.88351154071284), 12);
                map.setUIToDefault();
                showStartingMarker();
      	}
}
			...
			function(point) {
				if (!point) {
					// do something
                                	...
                                	var centerLat = -42.883511;
                                        var centerLng = 147.344512;
        ...
        function showAddress(phone_number,sms_format, status_code, date_time, loc_start) {
			...
			function(point) {
				if (!point) {
					...
					var centerLat = -42.88351154071284;
                                        var centerLng = 147.34451293945312;
