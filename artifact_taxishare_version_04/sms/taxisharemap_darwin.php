...
<script type="text/javascript">
	...
	var map;
	var address = "Darwin Australia";
	var centerLat;
	var centerLng;
	var airportname ="Darwin Airport";
	var cur_sms_format;
...
function load() {
 if (GBrowserIsCompatible()) {
		...
		map.setCenter(new GLatLng(131.04835510253906,-12.52976391), 12);   
                map.setUIToDefault();
                showStartingMarker();
      	}
}
			...
			function(point) {
				if (!point) {
					// do something
                                	...
                                	var centerLat =  -12.52976391;
                                        var centerLng = 131.04835510253906;
