...
<script type="text/javascript">
	...
	var map;
	var address = "Adelaide Australia";
	var centerLat;
	var centerLng;
	var airportname ="Adelaide Airport";
	var cur_sms_format;
...
function load() {
 if (GBrowserIsCompatible()) {
		...
		map.setCenter(new GLatLng(138.61106872558594, -34.91239942857933), 12); 
                map.setUIToDefault();
                showStartingMarker();
      	}
}
        ...
        function showAddress(phone_number,sms_format, status_code, date_time, loc_start) {
			...
			function(point) {
				if (!point) {
					...
					var centerLat = -34.91239942857933;
                                        var centerLng = 138.61106872558594;
