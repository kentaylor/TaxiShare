...
<script type="text/javascript">
	...
	var map;
	//var address = "Mayfield NSW Australia";
...
function load() {
 if (GBrowserIsCompatible()) {
		map = new GMap2(document.getElementById("map"));
                //map.setCenter(new GLatLng(151.558573, -32.734714), 12); //set center to newcastle
...
<script>
          ...
          // Retrieve the object
           ...
           point = new GLatLng(place.Point.coordinates[1],
					...
					// do something
                                        ...
                                        //var centerLat = -32.734714;
                                        //var centerLng = 151.558573;
	...
	function removepin01(sms_format) {
                geocoder.getLatLng(
	...
	function showAddress(phone_number,sms_format, status_code, date_time) {
        ...
        function showAddress01(phone_number,sms_format, status_code, date_time) {
                geocoder.getLatLng(
			sms_format + "Australia",
			function(point) {
				if (!point) {
			...
			function(point) {
				if (!point) {
					// do something
                                        ...
                                        //icon.image = '<? echo $mosConfig_live_site ?>'+ "./startsign01.jpg";
    					...
    					marker.title = airportname;
    				        map.addOverlay(marker);
                                        ...
                                        var html;
    				        GEvent.addListener(marker, "mouseover", function() {
                                              //html = '<div style="font-family:arial;font-size:28px;text-align:left;color:red;">' + "You are here SYDNEY AIRPORT" + '</div>';
                                              //html = '<div style="font-family:arial;font-size:21px;text-align:left;color:red;">' + "You Are Here" + '</div>' + '<div style="font-family:arial;font-size:28px;text-align:left;color:red;">' + SYDNEY AIRPORT + '</div>';
                                              html = '<div style="font-family:arial;font-size:28px;text-align:left;color:green;">' + "You Are Here " + '</div>' + '<div style="font-family:arial;font-size:17px;text-align:right;color:green;">' + "NEWCASTLE AIRPORT" + '</div>';
