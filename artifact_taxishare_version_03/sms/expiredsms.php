  ...
  // End Initialization
	 ...
	 $pass="root";
  	 ...
  	 $database=mysql_select_db($db);
        ...
        $getunmatched = mysql_query("SELECT DISTINCT id, phone_number FROM incomingsmslog WHERE status_code = 0 AND DATE_ADD(date_time, INTERVAL 15 MINUTE)<NOW() ORDER BY date_time DESC");
